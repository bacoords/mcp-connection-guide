 ...
 *                                    Default 'false'.
 */
function mcp_connection_guide_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function mcp_connection_guide_register_package_scripts( $scripts ) {
	...
	foreach ( $scripts_data as $script_data ) {
		...
		mcp_connection_guide_override_script(
			$scripts,
			$script_data['handle'],
...
add_action( 'wp_default_scripts', 'mcp_connection_guide_register_package_scripts' );
