 ...
 *
 * Note: These styles can be overridden by calling mcp_connection_guide_override_style()
 ...
 */
function mcp_connection_guide_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function mcp_connection_guide_register_package_styles( $styles ) {
	...
	foreach ( $styles_data as $style_data ) {
		mcp_connection_guide_override_style(
			$styles,
			$style_data['handle'],
...
add_action( 'wp_default_styles', 'mcp_connection_guide_register_package_styles' );
